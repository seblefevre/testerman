...
ReturnError=asn1.SEQUENCE ([('invokeID',None,InvokeIdType,0),
    ('errorCode',None,ErrorCode,0),
    ('parameter',None,Parameter,1)], seq_name = 'ReturnError')
...
ExternalPDU=asn1.TYPE(asn1.IMPLICIT(8,cls=asn1.UNIVERSAL_FLAG),asn1.SEQUENCE ([('oid',None,asn1.OBJECT_IDENTIFIER,0),
    ('dialog',None,asn1.TYPE(asn1.IMPLICIT(0,cls=asn1.CONTEXT_FLAG),Dialog1),0)], seq_name = 'ExternalPDU'))
...
Reject=asn1.SEQUENCE ([('invokeIDRej',None,    asn1.CHOICE ([('derivable',None,InvokeIdType),
        ('not_derivable',None,asn1.NULL)]),0),
    ('problem',None,    asn1.CHOICE ([('generalProblem',None,asn1.TYPE(asn1.IMPLICIT(0,cls=asn1.CONTEXT_FLAG),GeneralProblem)),
        ...
        ('returnErrorProblem',None,asn1.TYPE(asn1.IMPLICIT(3,cls=asn1.CONTEXT_FLAG),ReturnErrorProblem))]),0)], seq_name = 'Reject')
Invoke=asn1.SEQUENCE ([('invokeID',None,InvokeIdType,0),
    ('linkedID',None,asn1.TYPE(asn1.IMPLICIT(0,cls=asn1.CONTEXT_FLAG),InvokeIdType),1),
    ('opCode',None,OPERATION,0),
    ('parameter',None,Parameter,1)], seq_name = 'Invoke')
ReturnResult=asn1.SEQUENCE ([('invokeID',None,InvokeIdType,0),
    ('resultretres',None,    asn1.SEQUENCE ([('opCode',None,OPERATION,0),
        ('parameter',None,Parameter,1)], seq_name = None),1)], seq_name = 'ReturnResult')
...
End=asn1.SEQUENCE ([('dtid',None,DestTransactionID,0),
    ('dialoguePortion',None,DialoguePortion,1),
    ('components',None,ComponentPortion,1)], seq_name = 'End')
Begin=asn1.SEQUENCE ([('otid',None,OrigTransactionID,0),
    ('dialoguePortion',None,DialoguePortion,1),
    ('components',None,ComponentPortion,1)], seq_name = 'Begin')
Continue=asn1.SEQUENCE ([('otid',None,OrigTransactionID,0),
    ('dtid',None,DestTransactionID,0),
    ('dialoguePortion',None,DialoguePortion,1),
    ('components',None,ComponentPortion,1)], seq_name = 'Continue')
Unidirectional=asn1.SEQUENCE ([('dialoguePortion',None,DialoguePortion,1),
    ('components',None,ComponentPortion,0)], seq_name = 'Unidirectional')
